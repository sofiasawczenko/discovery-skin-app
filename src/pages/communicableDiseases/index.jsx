...
export function CommunicableDiseases() {
  return (
    <div>
      ...
      <AlertasText>
        <h3>Alertas gerais dos especialistas</h3>O aumento de umidade e calor
        favorece o aparecimento de fungos, portanto, para prevenir a
        contaminação, é importante manter a pele seca e saudável, além de se
        atentar a qualquer sinal diferente pelo corpo. Muitas pessoas têm
        infecções fúngicas recorrentes, então, aos primeiros sinais de micose é
        necessário procurar atendimento médico para confirmar o diagnóstico. A
        doença pode ser confundida com alergia e outros problemas, por isso é
        tão importante identificar alterações desde o início. O tratamento
        depende do tipo de micose e da área que ela atingiu. O acompanhamento é
        fundamental, pois alguns medicamentos têm interação com outros remédios
        e alguns podem até causar alterações no...
      </AlertasText>
    </div>
  );
}
