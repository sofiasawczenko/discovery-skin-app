...
import baby2 from '/src/assets/child/baby2.svg';
    ...
    export function ChildMortality () {
        return (
            ...
            </ChildMortalityCont><SubTitle>
                    REDUÇÃO DA MORTALIDADE INFANTIL
                </SubTitle>

                <CenteredImage src={baby1} alt="Child" title="Child" />
                    ...
                    <p>
                        ...
                        As crianças têm a pele mais sensível e delicada. Por isso, o melanoma nessa faixa etária se apresenta de uma forma diferente dosadultos. Enquanto nos adultos geralmente as lesões têm coloração escura, nas crianças elas costumam ser esbranquiçadas, amareladas ou rosadas. 
                        ...
                        <li>Uma lesão similar a uma verruga, de cor amarelada, esbranquiçada ou rosada.</li>
                        <li>Sinais de aparência estranha e tamanho grande, diferentes de outras pintas existentes no corpo da criança.</li>
                            </ul>
                         </SintomaTopicos>

                         <CenteredImage2 src={baby2} alt="Child" title="Child" />
                        ...
                        <li>A corresponde à Assimetria. Sinais normais são assimétricos.</li>

                        <li>B corresponde a Bordas irregulares. Pintas benignas têm bordas arredondadas, e lesões potencialmente cancerígenas têm bordas irregulares.</li>

                        <li>C corresponde à Cor. Lesões benignas têm coloração uniformes, enquanto lesões cancerígenas têm diversas cores.</li>

                        <li>D corresponde a Diâmetro. Pintas maiores de 0,5 cm são suspeitas.</li>
