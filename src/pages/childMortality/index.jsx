...
export function ChildMortality() {
  return (
    <>
      ...
      <SubTitle>REDUÇÃO DA MORTALIDADE INFANTIL</SubTitle>
      ...
      <BodyText>
        <p>
          ...
          <ABCDText>
            ...
            uma quantidade excessiva de nevos é fator de risco para melanoma.
            Para saber se um sinal é suspeito de câncer de pele, os pais podem
            usar a REGRA do ABCDE, onde:
          </ABCDText>
          <ABCDTopicos>
            <ul>
              <li>
              ...
              <li>
                D corresponde a Diâmetro. Pintas maiores de 0,5 cm são
                suspeitas.
              </li>
            </ul>
          </ABCDTopicos>
